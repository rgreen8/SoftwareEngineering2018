...
public class MapBuilder {
	...
	private void buildRoads(){
		roads.put("Western Highway",new Road(new Point(800,0),new Point (800,1000),Direction.SOUTH,true,false, true));
		roads.put("Skyway",new Road(new Point(400,0),new Point (400,1000),Direction.SOUTH,true,false, false));		
		roads.put("EastWest",new Road(new Point(418,700),new Point (782,700),Direction.WEST,true,true, false));
	}
	
	private void buildCrossingGates(){
		gates.put("Gate1", new CrossingGate(780,480, "GateRight"));
		gates.put("Gate2", new CrossingGate(380,480, "GateLeft"));		
	}
	
	private void buildTracks(){
		tracks.put("Royal", new RailwayTracks(new Point(0,500),new Point(1200,500)));
		tracks.put("Royal2", new RailwayTracks(new Point(0,550),new Point(1200,550)));
	}
