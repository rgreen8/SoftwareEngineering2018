...
public class CarFactory {
	...
	public CarFactory(Direction direction, Point location, Collection<CrossingGate> gates, boolean allowTurns){
	...
	public Car buildCar(){
		if (previousCar == null || location.y < previousCar.getVehicleY()-100){
			Car car = new Car(location.x,location.y, allowTurns);	
			double speedVariable = (Math.random() * 10)/10;
			car.setSpeed((2-speedVariable)*0.8); 
